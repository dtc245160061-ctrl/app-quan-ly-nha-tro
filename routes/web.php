...
use App\Http\Controllers\Admin\User\AuthController as LegacyAuthController;
...
use App\Http\Controllers\Motel\DashboardController as MotelDashboardController;
use App\Http\Controllers\Motel\ContractController as MotelContractController;
use App\Http\Controllers\Motel\InvoiceController as MotelInvoiceController;
use App\Http\Controllers\Motel\RevenueController;
use App\Http\Controllers\Motel\RoomController as MotelRoomController;
use App\Http\Controllers\Motel\TenantController as MotelTenantController;
...
Route::get('/home', [PublicSiteController::class, 'index'])->name('public.home');
Route::get('/phong/{id}', [PublicSiteController::class, 'roomDetail'])->name('public.room-detail');

Route::middleware(['auth', 'role:admin'])->prefix('motel')->name('motel.')->group(function () {
    Route::get('/dashboard', [MotelDashboardController::class, 'index'])->name('dashboard');
    Route::get('/revenue', [RevenueController::class, 'index'])->name('revenue.index');

    Route::resource('rooms', MotelRoomController::class)->except(['show']);
    Route::resource('tenants', MotelTenantController::class)->except(['show']);

    Route::get('contracts', [MotelContractController::class, 'index'])->name('contracts.index');
    Route::get('contracts/create', [MotelContractController::class, 'create'])->name('contracts.create');
    Route::post('contracts', [MotelContractController::class, 'store'])->name('contracts.store');
    Route::post('contracts/{contract}/checkout', [MotelContractController::class, 'checkout'])->name('contracts.checkout');

    Route::get('invoices', [MotelInvoiceController::class, 'index'])->name('invoices.index');
    Route::get('invoices/create/{contract?}', [MotelInvoiceController::class, 'create'])->name('invoices.create');
    Route::post('invoices', [MotelInvoiceController::class, 'store'])->name('invoices.store');
});

//AUTH
Route::GET('admin', [LegacyAuthController::class, 'index'])->name('auth.admin');
Route::post('legacy-login', [LegacyAuthController::class, 'login'])->name('auth.login');
Route::get('legacy-logout', [LegacyAuthController::class, 'logout'])->name('auth.logout');
Route::GET('forgetPass', [LegacyAuthController::class, 'forgetPass'])->name('auth.forgetPass');
Route::POST('password/email', [LegacyAuthController::class, 'sendResetLinkEmail'])->name('auth.sendResetLinkEmail');
Route::GET('password/show-otp', [LegacyAuthController::class, 'showOTP'])->name('password.otp');
Route::post('password/verify-otp', [LegacyAuthController::class, 'verifyOtp'])->name('password.verify');
Route::get('password/resetView', [LegacyAuthController::class, 'resetView'])->name('password.resetView');
Route::post('password/reset', [LegacyAuthController::class, 'reset'])->name('password.reset');
Route::post('password/updatePassword', [LegacyAuthController::class, 'updatePassword'])->name('password.updatePassword');
//DASHBOARD
